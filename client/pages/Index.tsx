        ...
        {mobileMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-background/95 backdrop-blur-md border-b border-border">
            <nav className="flex flex-col p-4 space-y-4">
              <button onClick={() => scrollToSection('home')} className="text-left hover:text-primary transition-colors font-bold">Home</button>
              <button onClick={() => scrollToSection('about')} className="text-left bg-primary text-white px-4 py-2 rounded-full text-sm w-fit font-bold">About Me</button>
              <button onClick={() => scrollToSection('services')} className="text-left hover:text-primary transition-colors font-bold">Services</button>
              <button onClick={() => scrollToSection('projects')} className="text-left hover:text-primary transition-colors font-bold">Projects</button>
              <button onClick={() => scrollToSection('testimonials')} className="text-left hover:text-primary transition-colors font-bold">Testimonials</button>
              <button onClick={() => scrollToSection('contact')} className="text-left hover:text-primary transition-colors font-bold">Contact</button>
            </nav>
          </div>
        )}
      </header>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              We create mouth-watering conversion-focused food and beverage websites with 
              best layouts, smooth navigation, and beautiful design that turn visitors into 
              orders that help customers coming back.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card className="p-6 border border-border bg-card hover:bg-card/80 transition-colors">
              ...
              <p className="text-muted-foreground text-sm">
                Designing custom websites with optimal usability, beauty, and responsiveness.
              </p>
            </Card>
        ...
        <div className="container mx-auto">
          ...
          <div className="flex justify-center mb-8">
            <div className="flex bg-muted rounded-full p-1">
              ...
              <button className="px-4 py-2 text-sm font-medium bg-primary text-white rounded-full">Web Design</button>
              <button className="px-4 py-2 text-sm font-medium">App Design</button>
              <button className="px-4 py-2 text-sm font-medium">Graphic Design</button>
            </div>
          </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground mb-4">
                    "Working with this designer was an absolutely fantastic experience. 
                    The design was different perfectly beyond expectations. The 
                    attention to detail was remarkable with a clean, modern layout. The 
                    result was truly amazing product image."
                  </p>
                  <div>
        ...
        <div className="container mx-auto">
          <div className="flex flex-col lg:flex-row justify-between items-center">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-sm">
              ...
              <div>
                <h3 className="font-semibold mb-3 text-primary">Get the latest information</h3>
                <div className="flex">
                  <Input 
